		...
		<div class="col-xl-10 col-lg-10 offset-xl-1 offset-lg-1">
			...
			<section id="contact" class="margin-bottom-60">
				...
				<form action="{{url('/user/task/conversation/post/'.$projects->projects_uniq.'/'.$projects->title)}}" id="form-conversation" method="post" enctype="multipart/form-data">
					...
					<div class="input-with-icon-left" style="display:flex;">
						<input class="with-border" style="padding-left: 90px;width:60%" name="ammount" id="ammount" value="{{$_GET['ammount']}}" type="number" id="subject" placeholder="Your Bid Ammount" required="required">
						<i class="icon-line-awesome-money" style="width:75px"> IDR</i>
						<!-- Fields -->
						<div class="bidding-fields" style="display:flex;    margin-left: 10%;">
							<div class="bidding-field">
								<!-- Quantity Buttons -->
								<div class="qtyButtons" style="width: 100%;">
									<div class="qtyDec"></div>
									<input type="text" name="finish_time" id="finish_time" value="{{$_GET['qtyInput']}}">
									<div class="qtyInc"></div>
								</div>
							</div>

							<select class="selectpicker default" tabindex="-98" name="time_type" style="width:110px;margin-left:10%" required="">
								@if($_GET['time'] == 'Days')
					...
					<input type="button" class="submit button margin-top-15" id="submit" value="Submit Your Bid" onclick="submitconv()">
...
function  submitconv(){
	...
	console.log(finish_time,ammount);
	...
	if (ammount == null || ammount <= 0) {
		alert('Bid Anda Tidak Boleh Kosong atau harus lebih besar dari 0!')
	}else if(finish_time == null || finish_time <= 0){
		alert('Waktu Pengerjaan Anda Tidak Boleh Kosong atau harus lebih besar dari 0!')
